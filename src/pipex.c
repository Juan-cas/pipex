...
/*   Updated: 2024/07/11 19:10:54 by juan-cas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	first_child(char **commands,
						t_env *infomation, int *fd, char **envp)
{
...
static void	last_child(char **commands,
						t_env *information, int *fd, char **envp)
{
	int		outputfd;
	char	*binary_location;

	binary_location = path_tester(information->paths,
			information->lst_commands[1][0]);
